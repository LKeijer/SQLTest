...
namespace SQLTest.Database1DataSetTableAdapters {
    ...
    public partial class AccountTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Account] ([Username], [Password]) VALUES (@Username, @Password" +
                ");\r\nSELECT AccountId, Username, Password FROM Account WHERE (AccountId = SCOPE_I" +
                "DENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Account] SET [Username] = @Username, [Password] = @Password WHERE (([AccountId] = @Original_AccountId) AND ([Username] = @Original_Username) AND ([Password] = @Original_Password));
SELECT AccountId, Username, Password FROM Account WHERE (AccountId = @AccountId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SQLTest.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT AccountId, Username, Password FROM dbo.Account";
